...
python src/ingestion/downloader.py --count 10000
```
...
curl -X POST "http://localhost:8000/ingest" \
  ...
  -d '{"filename": "pubmed_subset_10000.jsonl"}'
...
- Increase document count: `python src/ingestion/downloader.py --count 100000`
